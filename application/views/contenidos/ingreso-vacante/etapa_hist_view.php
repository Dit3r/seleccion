...
<div class="row" style="margin-top: 12px;">
	...
	<div class="col-md-6 volver" style="cursor: pointer; text-align: right; padding-right: 30px;">
		<a href="<?php echo site_url()."ingreso_vacante/historico"; ?>"><i class="fa fa-mail-reply"></i><span> Volver</span></a>
	</div>
</div>
			...
			<li>
				...
				<?php endif; ?>
					<div class="der left">
						...
						<a class="toOvalo" data-etapa="<?php echo $ovalo->nroEtapa; ?>"  href="<?php echo site_url(); ?>etapa_vac/historico/<?php echo $idSolicitud; ?>/<?php echo $ovalo->nroEtapa; ?>/<?php echo $ovalo->correlativo; ?>/<?php echo $this->uri->segment(6); ?>">
